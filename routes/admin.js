...
router.post('/mark-employee', function markEmployee(req, res) {
    var newAttendance = new Attendance();
    newAttendance.employeeID = req.body.markemployeeid;
    ...
    res.redirect(`/admin/view-employee-attendance/${req.body.markemployeeid}`);
})
